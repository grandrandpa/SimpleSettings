...
public class BluetoothPairingDialogFragment extends DialogFragment implements
    ...
    private View createView() {
        ...
        TextView pairingTitle = (TextView) view.findViewById(R.id.title_view);
        ...
        view.findViewById(R.id.button_ok).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mPairingController.onDialogPositiveClick(BluetoothPairingDialogFragment.this);
                mPairingDialogActivity.dismiss();
            }
        });
        ...
        view.findViewById(R.id.button_cancel).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mPairingController.onDialogNegativeClick(BluetoothPairingDialogFragment.this);
                mPairingDialogActivity.dismiss();
            }
        });

        pairingTitle.setText(getString(R.string.bluetooth_pairing_request,
                mPairingController.getDeviceName()));
