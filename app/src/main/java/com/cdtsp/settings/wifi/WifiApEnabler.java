...
package com.cdtsp.settings.wifi;
...
public class WifiApEnabler {
    ...
    private final SettingSwitchItem mSwitch;
    ...
    public WifiApEnabler(Context context, SettingSwitchItem switchPreference) {
        mContext = context;
...
//                        (wifiConfig == null) ? s : wifiConfig.SSID)));
    ...
    private void handleWifiApStateChanged(int state, int reason) {
        Log.d(TAG, "handleWifiApStateChanged state:" + state +", reason:" + reason);
        switch (state) {
